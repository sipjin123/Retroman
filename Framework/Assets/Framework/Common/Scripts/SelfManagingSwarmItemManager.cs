...
public class SelfManagingSwarmItemManager : SwarmItemManager
{
	 ...
	 */
    public override void KillAllActiveItems()
    {
	 ...
	 */
    public override void PruneInactiveList(int itemPrefabIndex, int maxCount)
    {
	 ...
	 */
    public override void Preload(int itemPrefabIndex, int preloadCount)
    {
