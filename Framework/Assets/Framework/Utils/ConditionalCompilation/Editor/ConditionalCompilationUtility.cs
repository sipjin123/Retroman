...
namespace ConditionalCompilation
{
    ...
    /// [AttributeUsage(AttributeTargets.Assembly, AllowMultiple = true)]   // | This is necessary to allow multiple declarations of this attribute
    ...
    /// </example>
    /// </para>
    /// <para/>Source: https://github.com/Unity-Technologies/EditorXR/blob/development/Scripts/Utilities/Editor/ConditionalCompilationUtility.cs
    /// </summary>
    [InitializeOnLoad]
